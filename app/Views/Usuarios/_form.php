...
<div class="form-group">
    ...
    <input type="text" email="nome" placeholder="Insira o e-mail de acesso" class="form-control" value="<?php echo esc($usuario->email); ?>">
</div>
...
<div class="form-group">       
    ...
    <input type="password" name="password_confirmation" placeholder="Confirme sua senha de acesso" class="form-control">
</div>
